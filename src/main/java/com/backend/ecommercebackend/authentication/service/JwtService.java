...
/* implemented by Sedat, modified by me to store refresh tokens in Redis.
this is a preview of my modifications. do not just copy/paste codes until resolving problems with the branching*/
...
public class JwtService {
  ...
  public boolean validateRefreshToken(String email, String refreshToken) {
    /*
      RedisTokenService to validate the refresh token
     todo check if it is ok
    */

    return redisTokenService.validateRefreshToken(email, refreshToken) && !isTokenExpired(refreshToken);
  }
